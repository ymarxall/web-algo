        ...
        <div className="mb-10 sm:mb-12 -mt-6 sm:-mt-8 relative z-10">
          <div className="bg-gradient-to-r from-yellow-100 to-orange-100 rounded-2xl p-4 sm:p-6 md:p-8 shadow-lg border border-orange-200/50 w-full">
            <div className="flex items-start justify-between">
              ...
              <div className="hidden md:block w-28 h-32 sm:w-32 sm:h-40 ml-4 sm:ml-6">
                <div className="w-full h-full bg-gradient-to-br from-orange-300 to-orange-500 rounded-xl flex items-center justify-center text-white font-bold">
                  Coffee Image
                </div>
              </div>
            </div>
